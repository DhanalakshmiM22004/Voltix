...
function FooterLink({ href = "#", children }) {
  return (
    <a
      href={href}
      className="group relative inline-block text-gray-500 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-500 transition-colors duration-300 text-sm"
    >
      {children}
...
const contactDetails = [
  { icon: MapPin, text: "Anna Nagar, Chennai, Tamil Nadu" },
