          ...
          <div className="text-center lg:text-left">
            ...
            <Reveal delay={100}>
              ...
              >
                ...
                <span className="relative inline-block text-green-600">
                  ...
                  <svg
                    viewBox="0 0 200 12"
                    className="absolute left-0 -bottom-1 w-full h-3 text-green-500/50"
            ...
            <Reveal delay={300}>
              <div className="mt-7 flex flex-wrap justify-center lg:justify-start gap-4">
                <button className="bg-green-600 hover:bg-green-700 text-white font-semibold rounded-full px-7 py-3.5 flex items-center gap-2 shadow-lg shadow-green-600/20 hover:shadow-green-500/30 hover:-translate-y-0.5 transition-all duration-300">
                  Get Started
                  <ArrowRight size={17} />
                </button>
              </div>
