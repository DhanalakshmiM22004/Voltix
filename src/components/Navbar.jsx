...
export default function Navbar() {
  ...
  // Measure the active link's position and slide the underline 
    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white/90 dark:bg-[#07111D]/90 backdrop-blur-xl border-b border-gray-200 dark:border-gray-800 transition-all duration-300">
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-10 xl:px-14">
        <div className="h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 cursor-pointer">
            ...
            <div>
              <h1
                className="text-xl sm:text-2xl lg:text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white leading-tight"
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-5">
            ...
            <button className="bg-green-600 hover:bg-green-700 text-white px-5 xl:px-7 py-2.5 xl:py-3 rounded-full font-semibold shadow-lg hover:shadow-green-500/30 hover:-translate-y-0.5 transition-all duration-300 text-sm xl:text-base">
              Get Started
            </button>
          </div>
      ...
      >
        <div className="bg-white dark:bg-[#07111D] border-t border-gray-200 dark:border-gray-800 px-6 py-6 space-y-1">
          ...
          <button className="w-full mt-3 py-3 rounded-full bg-green-600 hover:bg-green-700 text-white font-semibold transition-colors duration-300">
            Get Started
          </button>
        </div>
      </div>
